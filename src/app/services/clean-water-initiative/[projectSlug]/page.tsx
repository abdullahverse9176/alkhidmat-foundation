...
export async function generateMetadata({ params }: PageProps) {
  ...
  return {
    title: `${project.title} - Clean Water Initiative`,
  ...
  return (
    <div className="relative min-h-screen bg-slate-50/50">
      ...
      <section className="relative min-h-[40vh] flex items-end overflow-hidden bg-neutral-dark pt-28 pb-12">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 w-full">
          ...
          <nav className="flex items-center gap-2 text-xs font-bold text-slate-400 uppercase tracking-wider mb-4">
            ...
            <span>/</span>
            <Link href="/services/clean-water-initiative" className="hover:text-emerald-400 transition-colors">Clean Water</Link>
            <span>/</span>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Back Link */}
        <Link 
          href="/services/clean-water-initiative" 
        ...
        >
          ...
          <span>Back to All Water Projects</span>
        </Link>
          ...
          <div className="lg:col-span-7 space-y-10">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-sm space-y-6">
              <h2 className="text-2xl font-bold text-slate-800 flex items-center gap-2">
                ...
                <span>Crisis & Water Solution Story</span>
              </h2>
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-sm relative overflow-hidden">
              ...
              <div className="mt-6 p-4 bg-emerald-50 rounded-2xl border border-emerald-100/50 flex gap-3 text-xs text-emerald-800">
                ...
                <p className="leading-relaxed">
                  Budget log vetted by regional auditors. Placing a similar handpump provides lifetime clean drinking water. Coordinate below.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-sm relative overflow-hidden">
              ...
              <div className="space-y-2.5">
                {project.cooperators.map((name, i) => (
